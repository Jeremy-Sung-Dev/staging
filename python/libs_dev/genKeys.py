...
if __name__ == '__main__':
    ...
    parser.add_option("-f", "--filename_sample", type="string", dest="filename_sample",
        help="Filename of the key file", metavar="filename_sample",
        default=default_values["filename_sample"])
