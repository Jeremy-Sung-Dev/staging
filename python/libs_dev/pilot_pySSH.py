...
if __name__ == "__main__":
  ...
  pilotSSH = pilot_pySSH(hostname=hostname, port=port, userid=userid, privateKey=privateKey_jsung)
  ...
  # Workaround due to "sudo":
  cmd = "echo {} | sudo -S {}".format(",.SOLpx.01", "cat /etc/sudoers")

  stdin, stdout, stderr = pilotSSH.ssh.exec_command(cmd)
