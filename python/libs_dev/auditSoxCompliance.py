...
Description: Generate PCI/Sox Compliance Audit report - Create Excel Workbook
Attributes:
  __version__ = "3.0.1"
  __project__ = Prod
...
class auditSoxCompliance():
  ...
  def getFilename(self, projName="Default", dirReports="."):
    ...
    if len(curNums_l) > 0 and sorted(curNums_l)[0].isdigit():
      latestFileSeqNum = str(int(max(curNums_l)))
      nextNum = str(int(max(curNums_l)) + 1)


    # pathCurReport_stg = r"C:/staging/python/pilot/test" + projName + r" Account Review " + latestFileSeqNum + r".xlsx"
    # pathNewReport_stg = r"C:/staging/python/pilot/test" + projName + r" Account Review " + nextNum + r".xlsx"
    # return pathCurReport_stg, pathNewReport_stg

    # pathCurReport_prd = r"C:/22-Linux-Architect/Audit-SOX-Compliance/" + projName + r" Account Review " + latestFileSeqNum + r".xlsx"
    # pathNewReport_prd = r"C:/22-Linux-Architect/Audit-SOX-Compliance/" + projName + r" Account Review " + nextNum + r".xlsx"
    # return pathCurReport_prd, pathNewReport_prd

    pathCurReport_prd = r"/root/data/auditReports/" + projName + r" Account Review " + latestFileSeqNum + r".xlsx"
...
if __name__ == "__main__":
  ...
  # generateSoxComplianceReport_MARS.genSoxComplianceReport_Ldap()
  #
  #
  #
  ...
  # generateSoxComplianceReport_Polling.genSoxComplianceReport_Ldap()
  #
  #
